...
//zwracanie indeksu zadanej strony przy braku -1
    ...
    public void addCSS(String[] settings) {
        ...
        if (!settings[4].isEmpty())
            css = css + "p{\n\tfont-size:" + settings[4] + "%\n}\n";

        if (!settings[2].isEmpty())
            css = css + "body{margin-left:" + settings[2] + "%;}";

        if (!settings[3].isEmpty())
            css = css + "body{margin-right:" + settings[3] + "%;}";
